...
label "HIGH_source" = (s_source=0);
label "LOW_source" = (s_source=1);
label "INC_source" = (s_source=2);
label "DEC_source" = (s_source=3);
label "IDLE_flow_1oo2" = (s_flow_1oo2=0);
label "INPUT1_flow_1oo2" = (s_flow_1oo2=1);
label "INPUT2_flow_1oo2" = (s_flow_1oo2=2);
label "START_compFI_1" = (s_compFI_1=0);
label "INPUT_REC_compFI_1" = (s_compFI_1=1);
label "START_compFI_2" = (s_compFI_2=0);
label "INPUT_REC_compFI_2" = (s_compFI_2=1);
label "Start_observer" = (s_observer=0);
label "Violation_observer" = (s_observer=1);
label "STEP1_observer" = (s_observer=2);
label "STEP2_observer" = (s_observer=3);
...
module compFI_1
	...
	[Tick] (s_compFI_1=0) & ((changed_source = true)) -> (s_compFI_1'=1) & (output_compFI_1'=true) & (oValue_compFI_1' = flow_1_source);
	[Tick] (s_compFI_1=1) & ((changed_source = true)) -> (s_compFI_1'=1) & (output_compFI_1'=true) & (oValue_compFI_1' = flow_1_source);

	//Generated self-loops for emulating synchronous execution semantics
	[Tick] (s_compFI_1=0) & ((changed_source = false)) -> (s_compFI_1'=0) & (output_compFI_1'=false);
	[Tick] (s_compFI_1=1) & ((changed_source = false)) -> (s_compFI_1'=1) & (output_compFI_1'=false);
endmodule
...
module compFI_2
	...
	[Tick] (s_compFI_2=0) & ((changed_source = true)) -> (s_compFI_2'=1) & (output_compFI_2'=true) & (oValue_compFI_2' = flow_2_source);
	[Tick] (s_compFI_2=1) & ((changed_source = true)) -> (s_compFI_2'=1) & (output_compFI_2'=true) & (oValue_compFI_2' = flow_2_source);

	//Generated self-loops for emulating synchronous execution semantics
	[Tick] (s_compFI_2=0) & ((changed_source = false)) -> (s_compFI_2'=0) & (output_compFI_2'=false);
	[Tick] (s_compFI_2=1) & ((changed_source = false)) -> (s_compFI_2'=1) & (output_compFI_2'=false);
endmodule
